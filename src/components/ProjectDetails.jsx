...
const ProjectDetails = () => {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 py-8 ${isOpen ? 'overflow-hidden' : ''}`}>
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${isOpen ? 'blur-sm' : ''}`}>
                ...
                {project.listOfDevelopers.map((dev, index) => (
                  ...
                  >
                    <div className="bg-white rounded-lg shadow-sm p-4 hover:shadow-md transition-shadow">
                      <p className="text-lg font-medium text-gray-900 mb-2">{dev.devName}</p>
